...
import { ArrowRight, Clock, Palette, Flame, Gift, Brush, Coffee } from 'lucide-react'
...
const PROCESS_STEPS = [
    {
        ...
        iconComponent: Palette,  // ✅ Perfecta per triar
        time: '5 min',
        color: 'terracotta'
    },
    {
        id: 2,
        title: 'Pinta i crea',
        description: 'Deixa volar la imaginació amb colors professionals i tècniques senzilles...',
        iconComponent: Brush,    // ✅ Icona pinzell
        time: '45-90 min',
        color: 'clay'
    },
    {
        id: 3,
        title: 'Gaudeix del café',
        description: 'Mentre crees, relaxa\'t amb el nostre cafè especialitat i dolços locals...',
        iconComponent: Coffee,   // ✅ Perfecta per aquest pas
        time: 'Durant la creació',
        color: 'cream'
    },
    {
        id: 4,
        title: 'Cocció màgica',
        description: 'Deixem la teva peça a professionals locals. La màgia passa al forn...',
        iconComponent: Flame,    // ✅ Representa el forn/cocció
        time: '5-7 dies',
        color: 'terracotta'
    },
    {
        ...
        description: 'T\'avisem quan estigui llesta. Vine a recollir la teva creació única!',
        iconComponent: Gift,     // ✅ Com un regal per recollir
        time: 'Quan estigui llesta',
        color: 'clay'
    }
]
const History = () => {
                ...
                <div className="relative">
                    ...
                    <div className="lg:hidden space-y-8">
                        {PROCESS_STEPS.map((step, index) => {
                            const IconComponent = step.iconComponent; // ✅ Obtenir la icona
                                    ...
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div className="flex-shrink-0">
                                            ...
                                            <div className="flex justify-center mt-2">
                                                {/* ✅ Usar la icona component */}
                                                <IconComponent className="w-6 h-6 text-terracotta-600" />
                                            </div>
                                        </div>
